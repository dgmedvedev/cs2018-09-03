package by.it_academy.students.andruhin.lesson04;
...
public class TaskB2
{
    public static void main(String[] args)
    {
        ...
        int Size = sc.nextInt();
        int[] BaseString = new int[Size];
        int[] CustomString = new int[Size];
        ...
        for (int j = 0; j < Size; j++)
        {
            for (int i = 0; i < Size; i++)
            {
                //CustomString[i] = BaseString[i] * (j + 1);
                System.out.print(BaseString[i] * (j + 1) + " ");
            }
            System.out.print("\n");
        }
        //System.out.print("1");
