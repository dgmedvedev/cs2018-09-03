...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Ноябрьским днём, когда защищены";
        String b = "от ветра только голые деревья,";
        String c = "а всё необнажённое дрожит,";
        String d = "я медленно бреду вдоль колоннады";
        String e = "дворца, чьи стекла чествуют закат";
        String f = "и голубей, слетевшихся гурьбою";
        String g = "к заполненным окурками весам";
        String h = "слепой богини. Старые часы";
        String i = "показывают правильное время.";
        String j = "Вода бурлит, и облака над парком";
        String k = "не знают толком что им предпринять,";
        String l = "и пропускают по ошибке солнце.";
